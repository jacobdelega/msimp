...
const EditableInfluencerCard = ({ user_data }) => {
    const handleUpdateInfluencer = async (data) => {
        try {
    ...
    const handleSave = () => {
        handleUpdateInfluencer(editedData);
        setIsEditing(false);
    };
            ...
            <div className='grid grid-cols-2 gap-4'>
                ...
                <div>
                    ...
                    {isEditing ? (
                        ...
                        <p className='text-gray-500 font-normal text-sm'>{user_data?.bio}</p>
                    )}
                </div>
            </div>
        </div>
...
export default EditableInfluencerCard;
